...
wether or not the element is deprecated in HTML 4.01 Strict.

=head4 C<[[start_tag]]>

Will be replaced by words "required" or "optional" indicating wether
...
(it defaults to C<irc_html_info>) will recieve input
...
Please report any bugs or feature requests to C<bug-poe-component-irc-plugin-html-elementinfo at rt.cpan.org>, or through
the web interface at L<http://rt.cpan.org/NoAuth/ReportBug.html?Queue=POE-Component-IRC-Plugin-HTML-ElementInfo>.  I will be notified, and then you'll
...
L<http://rt.cpan.org/NoAuth/Bugs.html?Dist=POE-Component-IRC-Plugin-HTML-ElementInfo>

=item * AnnoCPAN: Annotated CPAN documentation

L<http://annocpan.org/dist/POE-Component-IRC-Plugin-HTML-ElementInfo>

=item * CPAN Ratings

L<http://cpanratings.perl.org/d/POE-Component-IRC-Plugin-HTML-ElementInfo>

=item * Search CPAN

L<http://search.cpan.org/dist/POE-Component-IRC-Plugin-HTML-ElementInfo>
